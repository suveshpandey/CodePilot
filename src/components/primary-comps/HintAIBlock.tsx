        ...
        <div className="w-full h-full py-4 flex flex-col">
            ...
            <PanelGroup autoSaveId="example" direction="vertical">
                <Panel defaultSize={40} minSize={30}>
                    <div className="w-full h-full px-4 flex flex-col items-start justify-between">
                        <p className="text-slate-400 mb-2 text-md font-medium ">
                            Expected output:
                        </p>
                        <div className="h-full w-full gap-y-10 flex flex-row items-center justify-between">
                            <textarea
                                name="user-outout"
                                id="user-output"
                                ...
                                className="w-full h-[80%] p-3 rounded-md bg-slate-900 text-slate-200 placeholder-slate-500 border border-slate-600 focus:border-slate-400 focus:outline-none transition-colors"
                            />
                        ...
                        {isAiLoading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full w-full text-slate-500 gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-slate-300 hover:bg-slate-200 text-slate-900 w-40 h-10 mt-3 rounded-full font-medium cursor-pointer shadow-sm transition"
                                    >
                                    Get Hints
                                </button>
                            </div>
