...
export default function Navbar () {
    ...
    return (
        <div className="w-full h-full border-b-1 py-4 border-slate-700 text-slate-300 flex items-center justify-between">
            <p className="font-medium text-lg">CodePilot</p>
